                ...
                <div className="relative z-10 pt-12 pb-16 px-6 text-center max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-6xl  text-slate-900 mb-6 leading-tight">
                            ...
                            <span className="text-[#0369A1]">define the future.</span>
                        </h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            {cardData.map((card, idx) => (
                                ...
                                >
                                    ...
                                    {/* Icon */}
                                    <div className="relative mb-6 w-16 h-16 rounded-2xl bg-blue-50 flex items-center justify-center text-[#0369A1] group-hover:bg-[#0369A1] group-hover:text-white transition-all duration-300 shadow-inner">
                                        <card.icon size={32} />
                                    </div>
                                    ...
                                    {/* <div className="relative mt-auto pt-4 border-t border-slate-50 w-full flex justify-center">
                                        <span className="text-xs font-bold text-slate-400 group-hover:text-[#0369A1] uppercase tracking-widest flex items-center gap-2 transition-colors">
