                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            {cardData.map((card, idx) => (
                                ...
                                >
                                    ...
                                    {/* Icon */}
                                    <div className="relative mb-6 w-16 h-16 rounded-2xl bg-blue-50 flex items-center justify-center text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 shadow-inner">
                                        <card.icon size={32} />
                                    </div>
                                    ...
                                    <div className="relative mt-auto pt-4 border-t border-slate-50 w-full flex justify-center">
                                        <span className="text-xs font-bold text-slate-400 group-hover:text-blue-600 uppercase tracking-widest flex items-center gap-2 transition-colors">
