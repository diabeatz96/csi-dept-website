      ...
      <div className="max-w-8xl mx-auto px-6 w-full">
        ...
        >
          ...
          <div className={`w-full lg:w-7/12 p-8 lg:p-16 flex flex-col justify-center ${isImageLeft
            ...
            >
              <span className="text-[#0369A1] font-bold tracking-widest uppercase text-xs mb-2 block bg-blue-100 rounded-full w-fit p-2">
                {category}
              </span>
              ...
              {title.includes("Computer Science") && title.includes("BS") && (
                <p className="text-slate-600 text-sm mb-6">
                  ...
                  <a
                    ...
                    className="text-[#0369A1] hover:text-blue-800 underline"
                  >
                    ABET
                  </a>
                </p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {links.map((link, idx) => (
                    ...
                    >
                      <div className="bg-blue-50 text-[#0369A1] p-2 rounded-md group-hover:bg-[#0369A1] group-hover:text-white transition-colors">
                        {getIcon(link.type)}
                      </div>
              ...
              <div className="mt-10 flex gap-4">
                ...
                <button className="text-slate-600 font-bold px-6 py-3 hover:text-[#0369A1] transition-colors flex items-center gap-2">
