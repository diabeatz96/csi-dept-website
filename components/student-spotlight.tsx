...
const SpotlightItem = ({ story, index }: { story: typeof spotlights[0], index: number }) => (
    ...
    >
        <div className="shrink-0 mt-1">
            <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-[#0369A1] group-hover:bg-[#0369A1] group-hover:text-white transition-all duration-300 shadow-sm">
                <story.icon size={20} />
            </div>
        </div>
        ...
        <section className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                    <div>
                        <div className="flex items-center gap-2 text-[#0369A1] font-bold uppercase tracking-widest text-xs mb-2">
                            <Sparkles size={14} />
                            Student Success
                        </div>
