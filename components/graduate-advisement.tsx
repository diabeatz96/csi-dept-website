                        ...
                        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                            ...
                            <div className="flex-1 flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-6">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex flex-wrap items-center gap-3 text-xs md:text-sm">
                                        <a
                                            ...
                                            className="text-blue-600 hover:text-blue-700 font-medium transition-colors inline-flex items-center gap-1.5"
                                        >
                                            <Mail size={14} />
                                ...
                                <div className="flex-shrink-0 pt-2 md:pt-0 md:border-l md:border-slate-200 md:pl-6">
                                    <a
                                        href="#"
                                        className="text-blue-600 hover:text-blue-700 underline font-medium text-sm inline-flex items-center gap-1.5 transition-colors"
                                    >
                                        <BookOpen size={14} />
