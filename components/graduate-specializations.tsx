...
const CourseModule = ({ code, title, icon: Icon, delay }: { code: string, title: string, icon: any, delay: number }) => (
  ...
  >
    <div className="h-10 w-10 rounded-lg bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
      <Icon size={18} />
    </div>
    <div>
    ...
    >
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
        ...
        <div className="lg:w-1/3 flex flex-col items-start">
          <div className="p-3 bg-white rounded-2xl shadow-sm border border-slate-100 mb-6 text-blue-600">
            <data.icon size={32} />
          </div>
    ...
    <section className="bg-white py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-start max-w-7xl mx-auto mb-10">
          <div className='h-1 w-[14%] self-start bg-blue-600 mb-2' />
          <motion.h2
