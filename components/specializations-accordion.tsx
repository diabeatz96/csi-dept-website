...
const CourseBox = ({ code, title, isOr = false }: { code?: string, title: string, isOr?: boolean }) => (
    <div className={`relative flex-1 p-3 rounded-lg border ${isOr ? 'bg-orange-50 border-orange-200' : 'bg-blue-50 border-blue-100'
        ...
        {code && (
            <span className={`text-xs font-bold uppercase tracking-wider block mb-1 ${isOr ? 'text-orange-600' : 'text-[#0369A1]'
                }`}>
                {code}
            </span>
        )}
                ...
                >
                    ...
                    <div className="bg-slate-50 border-l-4 border-blue-500 p-5 rounded-r-lg max-w-3xl">
                        <p className="text-slate-700 mb-3">
                            ...
                            Please speak to your <a href="#" className="text-[#0369A1] underline font-bold hover:text-blue-800">advisor</a> if one of these specializations interests you so you can plan to take the corresponding courses.
                        </p>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-5 flex items-center gap-4">
                                        ...
                                        <div className={`text-lg font-bold font-mono ${isActive ? 'text-[#0369A1]' : 'text-slate-300'}`}>
                                            #{idx + 1}
                                        </div>
