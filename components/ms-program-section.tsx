                    ...
                    >
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
                            <div className='flex items-center gap-2 flex-col'>
                                <div className='h-1 w-[50%] self-start bg-[#0369A1] ' />
                            ...
                            <div className="flex items-center gap-4">
                                {quickLinks.map((link, index) => (
                                    <motion.a
                                        ...
                                        className="text-[#0369A1] hover:text-blue-700 font-medium text-sm md:text-base transition-colors flex items-center gap-1"
                                    >
                                        {link.name}
                        ...
                        <div className="space-y-8">
                            ...
                            >
                                <div className="flex items-start gap-4 mb-6">
                                    <div className="p-3 bg-blue-50 rounded-xl">
                                        <ClipboardCheck size={24} className="text-[#0369A1]" />
                                    </div>
                                    <div className="flex-1">
                                            ...
                                            <div className="divide-y divide-slate-200">
                                                ...
                                                >
                                                    <div className="flex gap-4">
                                                        <div className="flex-shrink-0 w-8 h-8 bg-[#0369A1] text-white rounded-lg flex items-center justify-center font-bold text-sm">
                                                            1
                                                        </div>
                                                        <div className="flex-1">
                                                            <p className="text-slate-700 leading-relaxed">
                                                                A <span className="font-semibold text-slate-900">Bachelor of Science degree in Computer Science or related area</span> with a <span className="font-semibold text-[#0369A1]">B average (3.0 out of 4.0)</span> overall and in the major.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </motion.div>
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <div className="space-y-2 ml-0">
                                                                {knowledgeAreas.map((area, index) => (
                                                                    ...
                                                                    >
                                                                        <div className="w-1.5 h-1.5 bg-[#0369A1] rounded-full mt-2 shrink-0" />
                                        ...
                                        <motion.div
                                            ...
                                            className="bg-blue-50/50 rounded-xl p-5 border-l-4 border-[#0369A1] space-y-3"
                                        >
                                            <p className="text-slate-700 leading-relaxed">
                            ...
                            >
                                <div className="flex items-start gap-4 mb-4">
                                    <div className="p-3 bg-blue-50 rounded-xl">
                                        <Target size={24} className="text-[#0369A1]" />
                                    </div>
                                    <div className="flex-1">
                                        ...
                                        <p className="text-slate-700 leading-relaxed">
                                            ...
                                            <a
                                                href="#"
                                                className="text-[#0369A1] hover:text-blue-700 underline font-medium inline-flex items-center gap-1"
                                            >
                                                (Ph.D.)
                            ...
                            >
                                <div className="flex items-start gap-4 mb-4">
                                    <div className="p-3 bg-blue-50 rounded-xl">
                                        <GraduationCap size={24} className="text-[#0369A1]" />
                                    </div>
                                    <div className="flex-1">
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            >
                                                <p className="text-slate-700 text-lg leading-relaxed">
                                                    A program of <span className="font-bold text-[#0369A1]">10 courses (30 credits)</span> with at least a <span className="font-bold text-[#0369A1]">3.0 (B) average</span>.
                                                </p>
                                            </motion.div>
                                            ...
                                            >
                                                <div className="bg-[#0369A1] px-6 py-4">
                                                            ...
                                                            <tbody className="divide-y divide-slate-200">
                                                                ...
                                                                >
                                                                    <td className="py-4 px-4">
                                                                        <span className="font-mono font-bold text-[#0369A1] text-sm md:text-base">CSC 716</span>
                                                                    </td>
                                                                ...
                                                                >
                                                                    <td className="py-4 px-4">
                                                                        <span className="font-mono font-bold text-[#0369A1] text-sm md:text-base">CSC 727</span>
                                                                    </td>
                                                                ...
                                                                >
                                                                    <td className="py-4 px-4">
                                                                        <span className="font-mono font-bold text-[#0369A1] text-sm md:text-base">CSC 740</span>
                                                                        <span className="text-slate-500 mx-2">-or-</span>
                                                                        <span className="font-mono font-bold text-[#0369A1] text-sm md:text-base">CSC 770</span>
                                                                    </td>
                                                                ...
                                                                >
                                                                    <td className="py-4 px-4">
                                                                        <span className="font-mono font-bold text-[#0369A1] text-sm md:text-base">CSC 759</span>
                                                                        <span className="text-slate-500 mx-2">-or-</span>
                                                                        <span className="font-mono font-bold text-[#0369A1] text-sm md:text-base">CSC 799</span>
                                                                    </td>
                                                                    <td className="py-4 px-4 text-slate-700">
                                            ...
                                            <motion.div
                                                ...
                                                className="space-y-4"
                                            >
                                                <div className="bg-blue-50/50 rounded-xl p-5 border-l-4 border-[#0369A1]">
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    <div className="p-3 bg-blue-50 rounded-xl">
                                        <BookOpen size={24} className="text-[#0369A1]" />
                                    </div>
                                    <div className="flex-1">
